...
<html lang="en">
    ...
    <head>
        ...
        <meta name="v=-width, initial-scale=1">
                ...
                <div class="st-content">
                                        ...
                                        <div class="col-sm-6 col-xs-12">
                                            <div class="call-to-action">
                                                <ul class="list-inline">
                                                    <li><a href="#"><i class="fa fa-phone"></i> 2380-0000</a></li>
                                                    <li><a href="#"><i class="fa fa-envelope"></i> admin@shunDEx.com</a></li>
                                                </ul>
                                            </div><!-- /.call-to-action -->
                                        </div><!-- /.col-sm-6 -->
                            ...
                            <div class="item active">
                                ...
                                <div class="container">
                                    <div class="carousel-caption">
                                        ...
                                        <div class="phone animated lightSpeedIn">2380-0000</div>
                    ...
                    <div class="container text-center">
                        ...
                        <form name="form1" method="post" action="searchresult.php">
                            <input name ="search" type="text" size="32" maxlength="15" />
                            <input type="submit" name="Submit" value="Search" />
                        </form>

                    </div>
                    <br>
                    <P class="container text-center">Search result</P>
                    <br>
                    ...
                    <div class="container text-center">
                        ...
                        $search_sql = 'SELECT invoiceNumber,recipientPH,shippingDate,
                                        shippingAdd3,shippingAdd4,expectedArrDate,shippingStatus 
                                        FROM internal WHERE invoiceNumber = ' . $_POST['search'];
