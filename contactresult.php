							...
							<div class="container mainnav">
								...
								<div class="collapse navbar-collapse navbar-collapse">
									...
									<ul class="nav navbar-nav navbar-right">
										<!-- Home -->
                                        <li class="dropdown"><a href="index.php">Home <span class="fa fa-angle-down"></span></a>
							...
							<div class="row content-row">
								...
								<div class="col-md-7">
									<div class="contact-map">
										<h3>Compensation Form</h3>
										<form id="mainContact" action="contactresult.php" method="POST">
											<div class="form-group">
											    <label for="invoiceNum">Invoice Number</label>
											    <input name="invoiceNum" type="text" class="form-control"  required="" placeholder="">
											</div>
							  ...
							  <div class="modal-dialog modal-lg">
							    <div class="modal-content">
							      ...
							      <div class="modal-body">
                                                                  <form id="contactForm" action="contactresult.php" method="POST">
										...
										<div class="form-group text-area">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input name="invoiceNum" type="text" class="form-control"  required="" placeholder="">
											<label for="message">Your Message</label>
											<textarea id="message" name="message" typr="text" class="form-control" rows="6" required="" placeholder=""></textarea>
										</div>
										...
										<button type="submit" class="btn btn-primary">Send Message</button>
                                                                                ...
                                                                                <?php
                                                                                    ...
                                                                                    $sql = "INSERT INTO compensation (compenNum, invoiceNumber, description, compenAmount, reason)
                                                                                            VALUES ('','".$_POST["invoiceNum"]."','".$_POST["message"]."', '', '')";
                                                                                            
                                                                                    $insert_query = mysqli_query($mysqli, $sql);
                                                                                    if( $insert_query ) {
